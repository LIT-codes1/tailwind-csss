...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-WIQQQB4U.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-EQRWD3CC.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-4GW7WVZT.js");
...
//# sourceMappingURL=chunk-OQPQ6SHS.js.map
